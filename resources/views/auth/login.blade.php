...
<div class="auth-form-sub">Masukkan NIK dan kata sandi Anda untuk masuk ke portal.</div>

{{-- Status Message --}}
@if(session('status'))
<div class="af-info-box" style="background:#f0fdf4;border-color:#bbf7d0;color:#166534;">
...
{{-- Error Global --}}
@if($errors->any())
<div class="af-info-box" style="background:#fef2f2;border-color:#fca5a5;color:#991b1b;">
