...
@section('title', 'Dashboard Pengurus RW')
...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
    <div class="bg-white rounded-xl border border-slate-200 p-5 flex items-center gap-4 shadow-xs">
        ...
        <div>
            ...
            <div class="text-xs font-bold text-slate-500 mt-0.5 uppercase tracking-wider">Surat Butuh TTD</div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl border border-slate-200 p-5 flex items-center gap-4 shadow-xs">
        ...
        <div>
            <div class="text-2xl font-extrabold text-slate-900">0</div>
            <div class="text-xs font-bold text-slate-500 mt-0.5 uppercase tracking-wider">Total Aduan RW</div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl border border-slate-200 p-5 flex items-center gap-4 shadow-xs">
        ...
        <div>
            ...
            <div class="text-xs font-bold text-slate-500 mt-0.5 uppercase tracking-wider">Saldo Kas RW</div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl border border-slate-200 p-5 flex items-center gap-4 shadow-xs">
        ...
        <div>
            <div class="text-2xl font-extrabold text-slate-900">0</div>
            <div class="text-xs font-bold text-slate-500 mt-0.5 uppercase tracking-wider">Total Warga RW</div>
        </div>
    </div>
</div>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    <div class="bg-white rounded-xl border border-slate-200 shadow-xs flex flex-col overflow-hidden">
        ...
        <div class="p-8 flex flex-col items-center justify-center text-center flex-1">
            ...
            <p class="text-xs text-slate-400 font-semibold mt-1">Tidak ada surat yang menunggu persetujuan tingkat RW saat ini.</p>
        </div>
    </div>
