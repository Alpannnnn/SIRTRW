...
<div class="grid grid-2">
    <x-card title="Tugas Perlu Tindakan">
        <x-empty-state title="Semua tugas selesai" message="Tidak ada surat yang menunggu persetujuan tingkat RW saat ini." />
    </x-card>
