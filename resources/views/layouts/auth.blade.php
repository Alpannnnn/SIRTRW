...
<body class="h-full font-sans antialiased text-slate-900 bg-slate-50 flex flex-col">
    ...
    {{-- Top Navbar --}}
    <header class="bg-white border-b border-slate-200 h-14 flex items-center justify-between px-6 flex-shrink-0 z-10">
        <a href="{{ route('home') }}" class="flex items-center gap-2">
            <div class="w-8 h-8 bg-teal-700 text-white rounded flex items-center justify-center font-extrabold text-sm shadow-xs">
            ...
            <div>
                <div class="text-xs font-extrabold text-slate-950 tracking-tight leading-none">SIRTRW JALAN NIKEL</div>
                <div class="text-[9px] text-slate-500 font-semibold tracking-wide mt-0.5">Portal Digital RT/RW Resmi</div>
            </div>
        </a>
        <a href="{{ route('home') }}" class="inline-flex items-center gap-1 text-xs font-bold text-slate-600 hover:text-teal-700 border border-slate-200 hover:border-teal-600 bg-white py-1.5 px-3 rounded-lg transition">
    ...
    <main class="flex-1 flex flex-col lg:flex-row min-h-0">
        ...
        <div class="hidden lg:flex lg:w-1/2 bg-teal-50 border-r border-slate-200 flex-col justify-center px-12 xl:px-16 py-12 relative overflow-hidden">
            {{-- Background decorative shapes --}}
            <div class="absolute -top-20 -right-20 w-72 h-72 bg-teal-100/50 rounded-full pointer-events-none"></div>
            <div class="absolute -bottom-20 -left-20 w-64 h-64 bg-teal-100/30 rounded-full pointer-events-none"></div>

            <div class="max-w-md relative z-10 space-y-6">
                <div class="inline-flex items-center gap-1.5 bg-teal-100 text-teal-800 font-extrabold text-[10px] px-3 py-1.5 rounded-md tracking-wider uppercase">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" class="w-3.5 h-3.5">
                ...
                <h2 class="text-3xl font-extrabold text-teal-900 tracking-tight leading-tight">
                    Layanan Mandiri Warga <br>
                    Jalan Nikel Kel. Bugel <br>
                    Kini Serba Digital
                </h2>

                <p class="text-sm text-teal-800/80 leading-relaxed font-medium">
                ...
                <div class="space-y-4 pt-4 border-t border-teal-200/50">
                    <div class="flex items-center gap-3 text-sm font-semibold text-teal-950">
                        <div class="w-8 h-8 bg-teal-700/10 text-teal-700 rounded-lg flex items-center justify-center flex-shrink-0">
        ...
        <div class="flex-1 bg-white flex flex-col justify-center items-center px-6 py-10 lg:py-12 overflow-y-auto">
            <div class="w-full max-w-[440px] flex flex-col justify-between h-full min-h-0">
                ...
                <div class="text-center text-[10px] text-slate-400 font-semibold uppercase tracking-wider border-t border-slate-100 pt-6 mt-8">
