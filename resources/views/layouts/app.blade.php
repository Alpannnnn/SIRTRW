    ...
    <aside class="sidebar" :class="{ 'open': sidebarOpen }">
        ...
        <nav class="sidebar-nav">
            <div class="nav-section">
                ...
                <a href="{{ route('aduan.index') }}" class="nav-link {{ request()->routeIs('aduan.*') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M3 3v1.5M3 21v-6m0 0 2.77-.693a9 9 0 0 1 6.208.682l.108.054a9 9 0 0 0 6.086.71l3.114-.732a48.524 48.524 0 0 1-.005-10.499l-3.11.732a9 9 0 0 1-6.085-.711l-.108-.054a9 9 0 0 0-6.208-.682L3 4.5M3 15V4.5"/></svg>
                    Pengaduan
                </a>

                <a href="{{ route('kas.dashboard') }}" class="nav-link {{ request()->routeIs('kas.*') ? 'active' : '' }}">
                ...
                <a href="{{ route('inventaris.katalog') }}" class="nav-link {{ request()->routeIs('inventaris.*') ? 'active' : '' }}">
            ...
            @auth
                @if(auth()->user()->isPengurusRt() || auth()->user()->isPengurusRw())
                    ...
                    <div class="nav-section">
                        ...
                        <a href="{{ route('admin.dashboard') }}" class="nav-link {{ request()->routeIs('admin.*') ? 'active' : '' }}" style="{{ request()->routeIs('admin.*') ? '' : '' }}">
                        ...
                        <a href="{{ route('kependudukan.index') }}" class="nav-link {{ request()->routeIs('kependudukan.*') ? 'active' : '' }}">
        ...
        <main class="content-area">
            ...
            @if(session('success'))
                <div class="alert alert-success" x-data="{ show: true }" x-show="show" x-transition>
                    ...
                    <button class="alert-dismiss" @click="show = false">&times;</button>
                </div>
            @endif
